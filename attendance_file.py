...
def login():
    if username_var.get() == "" or password_var.get() == "":
        ...
        try:
            conn = pymysql.connect(host = 'localhost', user = 'root', password = '', database = 'recall')
            curr = conn.cursor()
            ...
            if row == None:
                ...
                def manage_employee():
                    try:
                        ...
                        print("Hi Himanshu Sharma")
                        face = Label(first, text = "Management of Employee" , bg = "tan" , fg = "snow", padx = 15, pady = 15, font = ("Times New Roman", 20, "bold") ,borderwidth = 5, relief = RIDGE).place(x = 500, y = 10)
                        main = Label(first, bg = "green", borderwidth = 1).pack()
                        def back():
                            first.destroy() 
                    ...
                    ################################################## Employee Management form ###############################
                        ...
                        titles = Label(f2, text = "Manage Employee" ,bg = "wheat", font = ("Italic", 20, "bold")).place(x = 90, y = 30)
                        id = Label(f2, text = "Employee ID", bg = "wheat", font = ("italic",13, "bold")).place(x = 35, y = 100 )
                        E1 = Entry(f2,state="disabled", width = 20, textvariable = eid_var,  font = ("italic",13, "bold") ).place(x = 180  , y = 100)
                        post = Label(f2, text = "Post", bg = "wheat",  font = ("italic",13, "bold")).place(x = 35, y = 150 )
                        E2 = Entry(f2, width = 20, textvariable = post_var,  font = ("italic",13, "bold")).place(x =180, y = 150)
                        name = Label(f2, text = "Full Name", bg = "wheat", font = ("italic",13, "bold")).place(x =35, y = 200)
                        E3 = Entry(f2, width = 20, textvariable = fname_var , font = ("italic",12, "bold")).place(x = 180, y = 200)
                        gender = Label(f2, text = "Gender", bg = "wheat", font = ("italic",12, "bold")).place(x = 35, y= 250)
                        E7 = Combobox(f2, textvariable = gender_var , values = ["Male","Female","Others"], state = "readonly",  font = ("italic",11, "bold")).place(x = 180, y = 250)
                        no = Label(f2, text = "Contact.No", bg = "wheat", font = ("italic",12, "bold")  ).place(x = 35, y = 300)
                        E4 = Entry(f2, width = 20, textvariable = contact_var , font = ("italic",12, "bold") ).place(x = 180, y = 300 ) 
                        address = Label(f2, text = " Email Address", bg = "wheat", font = ("italic",12, "bold")).place(x = 35, y = 350)
                        ...
                        btn1 = Button(f3, text = "Add", bg = "gray64", height = "1", width = "7",command = add_employee, font = ("Times new Roman", 14 , "bold")).place(x = 10, y = 10)
                        btn2 = Button(f3, text = "Update", bg = "gray64", height = "1", width = "7", command = update, font = ("Times new Roman", 14 , "bold")).place(x = 105, y = 10)
                        btn3 = Button(f3, text = "Delete", bg = "gray64",  height = "1", width = "7", command = delete,  font = ("Times new Roman", 14 , "bold")).place(x = 205, y = 10)
                        btn4 = Button(f3, text = "Clear", bg = "gray64", height = "1", width = "7", command = clear, font = ("Times new Roman", 14 , "bold")).place(x = 305, y = 10)
                        ...
                        f3.place(x = 20, y = 550)
                    ################################################################################### Large Frame
                        f4 = Frame(first, height = 600, width = 900, bg = "SlateBlue", borderwidth = "3", relief = SUNKEN)
                        f4.place(x = 440, y = 90)
                        l1 = Label(first, text = "Search By:",font = ("times new roman", 18 ,"bold"),bg = "SlateBlue", fg = "white").place(x = 460, y = 100 )
                    ...
                    ################################################################################## Table frame
                        f5 = Frame(f4, bg = "SkyBlue1", borderwidth = "2", relief = SUNKEN)
                        ...
                        table1.heading("eid", text ="Employee_ID")
                        ...
                        table1.heading("address", text = " Email_Address")
                ...
                def train(): 
                    try:
                        ...
                        backgrd.pack()
                        train_title = Label(second, text = "Train the System", fg = 'LightSeaGreen', font = ("times new roman", 20, "bold"), bg = "LightYellow")
                        ...
                        btn = Button(second, text = "Start Training", fg = 'LimeGreen',font = ("Times new roman", 20, "bold"), command = progress, bg = "moccasin" )
    ...
    ######################################### Function to recognize the face
                ...
                topic = Label(attendance, text = manage , bg = "LightBlue" , fg = "ivory", padx = 15, pady = 15, font = ("Times New Roman", 20, "bold") ,borderwidth = 5, relief = RIDGE)
                topic.place (x = 0, y = 0,relwidth = 1)
                # faceslider()
                # faceslidercolor()

                photo1 = PhotoImage(file = "Photos/management.png", master = attendance)
                B1 = Button(attendance, image = photo1, text = "Employee Management",font = ("Times New Roman" , 15), fg = "lawn green", height =230, width = 265, command = manage_employee, compound = BOTTOM )
                B1.place(x = 20, y = 100)

                photo2 = PhotoImage(file = "Photos/face_recognizer.png",  master = attendance)
                B2 = Button(attendance, image = photo2 , text = "Face Recognizer", font = ("Times new roman", 15), fg = "lawn green", height = 230, width= 265, command = face_recognize, compound = BOTTOM )
                B2.place(x = 20, y = 400)
                photo3 = PhotoImage(file = "Photos/train.png",  master = attendance)
                B3 =  Button(attendance , image = photo3 , text = "Train the Data" , font = ("Times new roman", 15), fg = "lawn green" , height = 230, width= 265, command = train , compound = BOTTOM )
                B3.place(x = 360, y = 100)
                photo4 = PhotoImage(file = "Photos/exit1.png",  master = attendance )
                B4 = Button(attendance, text="Exit",image = photo4, fg = "lawn green",font = ("Times new Roman", 15), height = 230, width = 265 , command = exit, compound = BOTTOM)
                B4.place(x =1040, y = 400)
                photo5 = PhotoImage(file = "Photos/report.png" ,  master = attendance)
                B5 = Button(attendance, text = "Attendance Report", fg = "lawn green", font = ("Times new roman", 15), image = photo5, height = 230, width = 265, command = report, compound = BOTTOM)
                B5.place(x = 360, y = 400)
                photo6 = PhotoImage(file = "Photos/photosample.png",  master = attendance)
                B6 = Button(attendance, text = "Photo Samples" ,fg = "lawn green", font =("Times new roman",15), image = photo6, height = 230, width = 265, command = photo_samples, compound = BOTTOM )
                B6.place(x = 700, y= 100) 
                photo7 = PhotoImage(file = "Photos/passwordchange.png", master = attendance)
                B7 = Button(attendance, text="Admin Account" ,fg = "lawn green",font =("Times new roman",15), image = photo7, height = 230, width = 265, command = change, compound = BOTTOM )
                B7.place(x = 700, y = 400)
                photo8 = PhotoImage(file = "Photos/embeddings.png", master = attendance)
                B8 = Button(attendance, text = "Extract Embeddings", fg = "lawn green", font = ("Times new Roman", 15), image = photo8, height = 230, width = 265,command= face_embedding, compound = BOTTOM)
...
title = Label(face, text = "Admin Login Page" , font = ("times new roman", 30, "bold"), bg = "dark magenta", fg = "dark gray", bd = 7, relief = GROOVE)
title.place(x = 0, y = 0, relwidth = 1)

clock = Label(face , font = ("times",20,"bold"), bg = "DarkGreen", relief = GROOVE)
...
user_label = Label(login_frame , text = "Username", image = user_icon, bg= "dim gray", compound = LEFT, font = ("times new roman", 15, "bold")).grid( row  = 1 , column = 0, padx = 30, pady = 5)
...
submit_btn = Button(login_frame, text = "Log In",width = 10, activebackground = "blue", activeforeground = "white", command = login , font = ("times new roman", 20, "bold"),relief = GROOVE, bg = "ivory").grid(row = 3, column = 1, pady =25, padx = 25)
face.mainloop()            